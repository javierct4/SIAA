...
private DefaultListModel mdlDemandados = new DefaultListModel();
    ...
    public ActualizarInformacion(java.awt.Frame parent, boolean modal, Usuario u) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(kardexarchivo.KardexArchivoApp.class).getContext().getResourceMap(ActualizarInformacion.class);
    ...
    if(this.btnBuscar.isEnabled()){
        ...
        if(j.ExisteJuicio()){
            ...
            this.txtNumero.setEnabled(false);
             ...
             JOptionPane.showMessageDialog(null, "ESTE PROCESO AUN NO SE ENCUENTRA EN EL INVENTARIO DE ESTE ARCHIVO ?");
...
// TODO add your handling code here:
    ...
    String nombre=JOptionPane.showInputDialog(null,"     NOMBRES Y APELLIDOS ACTOR   ",mdlActores.getElementAt(this.lstActor.getSelectedIndex())); 
    
    LitigantesM lit= (LitigantesM) mdlActores.getElementAt(this.lstActor.getSelectedIndex());
    lit.lit_nombre=nombre.toUpperCase();
    mdlActores.set(this.lstActor.getSelectedIndex(),lit);
    
    //this.lstActor.setModel(mdlActores);
    
   /* LitigantesM litigante = new LitigantesM();
    litigante=(LitigantesM) lstActor.getModel().getElementAt(0);
...
// TODO add your handling code here:
    String nombre=JOptionPane.showInputDialog(null,"     NOMBRES Y APELLIDOS ACTOR   ",mdlDemandados.getElementAt(this.lstDemandado.getSelectedIndex())); 
     LitigantesM lit= (LitigantesM) mdlDemandados.getElementAt(this.lstDemandado.getSelectedIndex());
    lit.lit_nombre=nombre.toUpperCase();
    mdlDemandados.set( this.lstDemandado.getSelectedIndex(),lit);
...
private void btnGuardarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnGuardarMouseClicked
   ...
   JOptionPane a;
    String razon=JOptionPane.showInputDialog(null,"POR FAVOR INGRESE EL MOTIVO DE LA MODIFICACION...  ","Actualizacion de información",JOptionPane.QUESTION_MESSAGE); 
    
    if (razon!=null)
    if(   this.lstActor.getModel().getSize()!=0
      ...
      //  if (!juicio.ExisteJuicio()){
            if(juicio.GuardarJuicio()){
                   ...
                   aud.setJui_id(idjuicio);
                   aud.setUsu_id(this.user.usu_id);
                   aud.setAud_tabla("JUICIOS");
                   aud.setAud_motivo(razon);
                   aud.GuardarAuditoria();
                    this.btnGuardar.setVisible(false);
                    this.btnCancelar.setVisible(false);
               ...
               LitigantesM litigante = new LitigantesM();
                ...
                for(int i=0;i<lstActor.getModel().getSize();i++){
                    litigante=(LitigantesM) lstActor.getModel().getElementAt(i);
                    //System.out.println(lstActor);
                ...
                //DEMANDADOS
                 for(int i=0;i<lstDemandado.getModel().getSize();i++){
                    ...
                    litigante=(LitigantesM) lstDemandado.getModel().getElementAt(i);
                     //System.out.println(litigante.lit_nombre);
                    litigante.GuardarLitigante();
                    //System.out.println(litigante.lit_nombre);
                }
                 existejuicio=this.CargarJuicio(idjuicio,juicio.jud_id);
                  String st="El juicio "+juicio.jui_id+"se actualizó correctamente....";
                  JOptionPane.showMessageDialog(null,st);
                bloquear(false);
            }
       /* } else {
...
// TODO add your handling code here:
    ...
    if (evt.getClickCount()==2 /*&& this.lstActor.getSelectedIndex()>-1  */){
        //String nombre=JOptionPane.showInputDialog(null,"     NOMBRES Y APELLIDOS ACTOR   ",
                
          System.out.println(this.mdlActores.getElementAt(this.lstActor.getSelectedIndex()).toString()); 
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ActualizarInformacion dialog = new ActualizarInformacion(new javax.swing.JFrame(), true, new Usuario());
...
try{
            ...
            if(rs.next()){
               ...
               */
               mdlActores.removeAllElements();
               mdlDemandados.removeAllElements();
               this.CargarLitigantesM(idjuicio);
...
public void CargarLitigantesM(String idjuicio){
            ResultSet rs = null;
            BaseDatos conn = new BaseDatos("INVENTARIO");
            conn.Conectar();
